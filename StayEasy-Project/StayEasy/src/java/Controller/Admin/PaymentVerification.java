...
//        House h = (House) session.getAttribute("doctor");
...
//                    SendMail.Booking(Integer.parseInt(vnp_TxnRef), user.getEmail(), user.getFullname(), (String) session.getAttribute("date"), (String) session.getAttribute("time"), "Dịch vụ : " + s.getTitle(), fee, "Đã thanh toán");
...
//                    SendMail.Booking(Integer.parseInt(vnp_TxnRef), user.getEmail(), user.getFullname(), (String) session.getAttribute("date"), (String) session.getAttribute("time"), "Bác sĩ : " + d.getDoctor_name(), fee, "Đã thanh toán");
//                    response.sendRedirect(request.getContextPath() + "/success");
//                    return;
//                }
//            }
