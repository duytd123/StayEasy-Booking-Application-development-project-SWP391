 ...
 * @author Admin
 */
public class getAdditionalServiceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            a = dao.getAdditionalServicebyID(id);
            if(a != null){
                request.setAttribute("aid", a);
                request.getRequestDispatcher("AdditionalService.jsp").forward(request, response);
            }
        }
    }
