...
public class ListServiceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<HouseAdditionalService> list = dao.getHouseAdditionalServicebyID(id);
            request.setAttribute("List", list);
            request.getRequestDispatcher("ListHouseAdditionalService.jsp").forward(request, response);
        }
    }
