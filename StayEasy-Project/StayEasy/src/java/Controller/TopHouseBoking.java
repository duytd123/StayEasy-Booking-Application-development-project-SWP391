 ...
 * @author khanh vi duy
 */
@WebServlet(name="TopHouseBoking", urlPatterns={"/TopHouseBoking"})
public class TopHouseBoking extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin1/top10.jsp").forward(request, response);
    }
