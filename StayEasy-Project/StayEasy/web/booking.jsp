            ...
            <div class="booking-form">
                ...
                <form action="booking" method="post" id="bookingForm">
                    ...
                    <div class="form-group">
                        ...
                        <input checked type="radio" name="method" value="cash" class="form-control-radio" /> Cash </br>
                        <input type="radio" name="method" value="vnpay" class="form-control-radio" /> VNPAY
                    </div>
