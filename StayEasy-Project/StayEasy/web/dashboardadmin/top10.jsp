                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listHouse}" var="t">
                                            <tr>
                                                <td class="text_page">${t.houseid}</td>
                                                <td class="text_page">${t.housename}</td>
                                                <td class="text_page" style="text-align: center">
                                                    <img style="width: 170px; height:180px" src="${t.image[0]}">
                                                </td>
                                                <td class="text_page">${t.houseprice} $</td>
                                                <td class="text_page">${t.numberBill}</td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
