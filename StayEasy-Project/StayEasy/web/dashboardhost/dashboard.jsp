                                        ...
                                        <div class="d-flex justify-content-between p-md-1">
                                            <div class="d-flex flex-row">
                                                <div class="align-self-center">
                                                    <i style="color: #1B813A; font-size: 50px" class="fas fa-thin fa-house me-3"></i>
                                                </div>
                                            </div>
                                            <div style="text-align: end">
                                                <h4 style="color: #1B813A">Total House</h4>
                                                <p class="mb-0"></p>
                                                <h2 class="h1 mb-0">${requestScope.houses}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <i style="color: #06439F; font-size: 50px" class="fas fa-regular fa-house-laptop me-3"></i>
                                            </div>
                                        </div>
                                        <div style="text-align: end"> 
                                            <h4 style="color: #06439F;">Number of House Now book</h4>
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0">${requestScope.status}</h2> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <i style="color: #06439F; font-size: 50px" class="fas fa-duotone fa-cart-shopping me-3"></i>
                                            </div>
                                        </div>
                                        <div style="text-align: end">
                                            <h4 style="color: #06439F;">Total Bill Pending</h4>
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0">${requestScope.bilsa}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
