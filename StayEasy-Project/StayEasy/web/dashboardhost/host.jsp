    ...
    <body>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <nav class="nav nav-borders">
                ...
                <a class="nav-link active" href="hostservlet">Profile</a>
                <a class="nav-link" href="securityhost">Security</a>
            ...
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <form action="hostservlet" method="post" enctype="multipart/form-data">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="hostservlet" method="post" id="userForm">
                                <!-- Form Group (username)-->
                                <div class="mb-3">
