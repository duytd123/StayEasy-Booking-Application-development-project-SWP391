    ...
    <div class="position-sticky" >
        <div class="list-group list-group-flush mx-3 mt-4" style="margin: 0">
            ...
            <a href="calendar" class="list-group-item list-group-item-action" style="margin-top: 10px">
                ...
                <span style="font-size: 16px; font-weight: 600">Booking Detail</span></a>
            ...
            <a href="..." class="list-group-item list-group-item-action" style="margin-top: 10px">
                <i style="margin-right: 10px; font-size: 18px" class="fas fa-thin fa-fire-flame-curved me-3"></i>
                <span style="font-size: 16px; font-weight: 600">Top Seller</span>
            </a>
            ...
            <a href="#" class="list-group-item list-group-item-action" style="margin-top: 10px">
                ...
                <span style="font-size: 16px; font-weight: 600">Edit More</span>
            </a>
        </div>
    </div>
</nav>