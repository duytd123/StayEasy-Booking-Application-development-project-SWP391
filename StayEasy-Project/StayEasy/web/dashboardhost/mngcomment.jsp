                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-sm-4" style="text-align: center; margin-top: 20px; margin-bottom: 20px; padding-top: 20px;">
                                    <h3 class="mb-0"><strong>Manage Comment</strong></h3>
                            ...
                            <div class="card-body" style="padding: 0">
                                <div class="table-responsive">
                                    <table class="table table-hover text-nowrap">
                                        <thead>
                                            <tr>
                                                <th style="padding-left: 40px" class="text_page_head">House Name</th>
                                                <th style="padding-left: 40px" class="text_page_head">User Name</th>
                                                <th class="text_page_head">Comment</th>
                                                <th class="text_page_head">Date</th>
                                                <th class="text_page_head">Reply</th>
                                                <th class="text_page_head">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${commentList}" var="w">
                                            <tr>
                                                <td style="padding-left: 40px" class="text_page" style="font-weight: 500">${w.houseName}</td>
                                                <td style="padding-left: 40px" class="text_page" style="font-weight: 500">${w.fullname}</td>
                                                <td class="text_page" style="font-weight: 500">${w.comment}</td>
                                                <td class="text_page" style="font-weight: 500">${w.date}</td>
                                                <td class="text_page" style="font-weight: 500">${w.reply != null ? w.reply : ''}</td>
                                                <td class="text_page">
                                                    <form action="replycomment" method="GET" >
                                                        <input type="hidden" name="commentId" value="${w.cid}">
