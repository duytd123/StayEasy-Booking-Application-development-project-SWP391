                    ...
                    <div class="myform form ">
                        ...
                        <form action="LoginServlet" method="post" name="login">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" value="<%=username %>" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter User name" autocapitalize="none" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Password</label>
                                <input type="password" name="password" value="<%=password %>" id="password" class="form-control" aria-describedby="emailHelp" placeholder="Enter Password" autocapitalize="none" autocomplete="off">
                            </div>
